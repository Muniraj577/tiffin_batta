...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Architects+Daughter&family=Arizonia&family=Barlow:wght@400;700&family=Cookie&family=Courgette&family=Dancing+Script&family=DynaPuff&family=Fjalla+One&family=Forum&family=Gabriela&family=Heebo&family=Jost&family=Just+Another+Hand&family=Kalam&family=Karla:wght@300;400&family=Kaushan+Script&family=Lato&family=Lobster&family=Lora&family=Lovers+Quarrel&family=Mitr&family=Monoton&family=Montez&family=Nunito:wght@400;900&family=Open+Sans:ital@1&family=PT+Sans+Narrow&family=PT+Sans:wght@400;700&family=Pacifico&family=Playfair+Display+SC:wght@700&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,600;1,800&family=Poppins&family=Public+Sans&family=Raleway:wght@500&family=Roboto&family=Roboto+Slab&family=Rufina&family=Satisfy&family=Secular+One&family=Suranna&family=Urbanist&display=swap"
        rel="stylesheet">
    <link rel="stylesheet"
